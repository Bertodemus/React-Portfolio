...
function Work() {
	return (
        ...
        <Project
					...
					repoLink={
						<a href='https://github.com/markdcross/perspektiv-v2' target='blank'>
							PERSPEKTIV V2 REPO
						</a>
					}
					tech={[
            ...
            "../../assets/images/logos/mongodb-logo.jpg",
					...
					demoView={
						<Image centered size='large' src='../../assets/images/p2view.png' />
					}
				/>
				...
				<Project
					...
					demoView={
						<Image centered size='large' src='../../assets/images/pview.png' />
					}
				/>
				...
				<Project
					...
					demoView={
						<Image centered size='large' src='../../assets/images/taview.png' />
					}
				/>
				...
				<Project
					...
					repoLink={
						<a href='https://github.com/Bertodemus/BudgetBuddy/' target='blank'>
							BUDGET BUDDY REPO
						</a>
					}
					tech={[
					...
					demoView={
						<Image centered size='large' src='../../assets/images/bbview.png' />
					}
				/>
				...
				<Project
					...
					demoView={
						<Image centered size='large' src='../../assets/images/bdview.png' />
					}
				/>
				...
				<Project
					...
					demoView={
						<Image centered size='large' src='../../assets/images/mview.png' />
					}
				/>
				...
				<Project
					...
					demoView={
						<Image centered size='large' src='../../assets/images/oview.png' />
					}
				/>
			</Grid>
		</div>
