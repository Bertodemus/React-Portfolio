  ...
  return(
    <div>
      ...
      <Segment basic style={{ margin: '0em 0em 1em 0em' }}>
        <Grid centered> 
          <Grid.Row>
            <Grid.Column width={7} textAlign='left' style={{ padding: '0em 3em 0em 0em' }}>
              <Grid.Row>
                <Grid.Column>
                  <Card.Group>
                    ...
                    <Card fluid>
                      <a href="https://bertodemus.github.io/Bifurcate/assets/files/RRResume.pdf"><Image src='../../assets/images/logos/resume.png' /></a>
                      <Card.Content>
                      <Card.Header>Resume</Card.Header>
                        <Card.Description>
                          <a href="https://bertodemus.github.io/Bifurcate/assets/files/RRResume.pdf">Download</a>
                        </Card.Description>
                      </Card.Content>
                    </Card>
            ...
            <Grid.Column width={7} textAlign='left' style={{ padding: '0em 0em 0em 3em' }}>
              <Grid.Row>
                <Grid.Column>
                  <Card.Group>
